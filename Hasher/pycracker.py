...
Example:
	...
	try:
		...
		print("" + '\033[33m' + "[" + '\033[37m' + "1" + '\033[33m' + "]" + '\033[32m' + " Generate a dictionary")
		print("" + '\033[33m' + "[" + '\033[37m' + "2" + '\033[33m' + "]" + '\033[32m' + " Crack a password")
		print("" + '\033[33m' + "[" + '\033[37m' + "3" + '\033[33m' + "]" + '\033[32m' + " Crack a password using a file")
		print("" + '\033[33m' + "[" + '\033[37m' + "4" + '\033[33m' + "]" + '\033[32m' + " Crack a hash using a dictionary file")
		choix = input("" + '\033[33m' + ":" + '\033[34m' + " " + '\033[37m' + "")
		if (choix == 1):
